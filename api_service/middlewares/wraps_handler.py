...
from api_service.middlewares.exceptions import InputDataValidationError
from api_service.middlewares.kwargs_handler import KwargsHandler
...
class WrapsKwargsHandler(KwargsHandler):
    ...
    def get_error_body(self, request: web.Request, error: Exception) -> dict:
        ...
        """ Формирует и отдает сообщение об ошибке. Для поля оболочки id использует сохраненное в request значение."""
